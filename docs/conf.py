# -*- coding: utf-8 -*-
#
# Syncto documentation build configuration file, created by
...
os.remove(os.path.join(destination, 'resource.rst'))
...
latex_documents = [
    ('index', 'Syncto.tex', u'Syncto Documentation',
...
man_pages = [
    ('index', 'syncto', u'Syncto Documentation',
...
texinfo_documents = [
    ('index', 'Syncto', u'Syncto Documentation',
     u'Mozilla Services — Da French Team', 'Syncto',
     'Talk to Firefox Sync with a Kinto clients.',
     'Miscellaneous'),
]
